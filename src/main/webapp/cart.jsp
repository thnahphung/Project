                    ...
                    <div class="row">
                        <div class="<%=cartItems.size()==0?" col-12":"col-8"%> list-product">
                            ...
                            <ul class="container-list-product">
                                <% if (cartItems.size() !=0) { for (LineItem line : cartItems) { Product
                                    ...
                                    <li class="product bd-bottom pb-4 pt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-3 p-0 left"><img
                                                    src="<%=product.getMainImage().getSource()%>" alt=""></div>
                                            <div class="col-6">
                                                <div class="top">
                                            ...
                                            <div class="col-3 right">
                                                <div class="top">
                                                    <div class="price">
                                                        <%=Format.format(line.totalPrice())%> VND
                                                    </div>
                                                    <div class="stocking">
                                        ...
                                        <div class="contain-bill p-4">
                                            ...
                                            <div class="top bd-bottom  pb-4">
                                                ...
                                                <div class="input-voucher">
                                                    ...
                                                    <button id="submit-voucher" class="uppercase submit">áp
                                                        dụng</button>
                                                </div>
                                            ...
                                            <div class="mid bd-bottom">
                                                <div class="arow">
                                                    <span>Đơn hàng</span>
                                                    <span class="total-real">
                                                        <%=Format.format(Cart.totalPrice(cartItems))%> VND
                                                    </span>
                                                </div>
                                                <div class="arow">
                                                    <span>Giảm</span>
                                                    <span class="sale">-
                                                        <%=Format.format(Cart.totalPriceSale(cartItems))%> VND</span>
                                                </div>
                                                <div class="arow">
                                                    <span>Mã khuyến mãi</span>
                                                    <span class="sale-voucher">- <span
                                                            class="money-sale-voucher">0</span> VND</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bottom">
                                                <div class="arow">
                                                    ...
                                                    <span class="total"><span>
                                                            <%=Format.format(Cart.total(cartItems))%>
                                                        </span> VND</span>
                                                </div>
