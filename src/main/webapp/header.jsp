...
<ul class="nav nav-page">
    ...
    <li class="nav-item center" id="nav-items">
        ...
        <a class="nav-link" id="gom" href="http://localhost:8080/listProduct?kind=<%=ProductService.CERAMIC%>&group=0&page=1&sort=0">Gốm</a>
        <a class="nav-link" href="http://localhost:8080/listProduct?kind=<%=ProductService.PAINT%>&group=0&page=1&sort=0">Tranh</a>
        <a class="nav-link" href="http://localhost:8080/listProduct?kind=<%=ProductService.SALE%>&group=0&page=1&sort=0">giảm giá</a>
