                    ...
                    <div class="content">
                        <% List<Order> list = (List<Order>) request.getAttribute("orderList");%>
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="top">
                                            ...
                                            <div class="title-number">
                                                ...
                                                <p class="number">
                                                    <%=request.getAttribute("total")%> VND
                                                </p>
                                            </div>
                                        </div>
                                        <div class="bottom">
                                    ...
                                    <div class="col-sm">
                                        <div class="top">
                                            <div class="icon i-red"><img src="" alt=""><i class="fa-solid fa-user "></i>
                                            </div>
                                            <div class="title-number">
                                    ...
                                    <div class="col-sm">
                                        <div class="top">
                                            <div class="icon i-blue"><img src="" alt=""><i class="fa-solid fa-eye"></i>
                                            </div>
                                            <div class="title-number">
                                        ...
                                        <table id="dtHorizontalVerticalExample"
                                            ...
                                            <tbody>
                                                <% for (Order order : list) { %>
                                                    <tr data-toggle="modal" data-target="#exampleModalCenterEdit">
                                                        <td class="order-id">
                                                            <%=order.getOrderId()%>
                                                        </td>
                                                        <td class="name">
                                                        ...
                                                        <td>
                                                            <%=order.getAddress().getAddressDetail().getDetail()%>
                                                                ,
                                                        ...
                                                        <td> <button class="detail-order"
                                                                value="<%=order.getOrderId()%>">xem chi tiết</button>
                                                        </td>
                                                    </tr>
                                                    <%}%>
