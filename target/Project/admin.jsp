        ...
        <%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8" %>
            ...
            <body>
                                ...
                                <div class="col-sm">
                                    <div class="top">
                                        ...
                                        <div class="title-number">
                                            ...
                                            <p class="number">
                                                <%=request.getAttribute("total")%> VND</p>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                ...
                                <div class="col-sm">
                                    <div class="top">
                                        ...
                                        <div class="title-number">
                                            ...
                                            <p class="number">
                                                <%=request.getAttribute("member")%> Người</p>
                                        </div>
                                    </div>
                                    <div class="bottom">
                ...
                %>
                            ...
                            <div class="modal fade" id="exampleModalCenterEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="width: 100%;">
