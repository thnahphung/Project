                                    ...
                                    <tbody>
                                        <% List<Banner> bannerList = (List<Banner>) request.getAttribute("listBanner");
                                                ...
                                                <tr class="name<%=banner.getId()%>">
                                                    ...
                                                    <td><img src="<%=banner.getImage_src()%>" alt=""
                                                            style="width: 200px; height: 100px"></td>
                                                    <td>
                                                        <button class="edit-banner" value="<%=banner.getId()%>"
                                                            data-toggle="modal" data-target="#exampleModalCenterEdit">
                                                            Sửa
                                                        </button>
                                                        <button type="button" class="delete-banner"
                                                            class="button btn-indigo btn-sm m-0 delete"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title uppercase" id="exampleModalLongTitle">Thêm quản
                                                    cáo mới</h5>
                                            ...
                                            <div class="modal-body">
                                                <form class="form-add-address">
                                                    ...
                                                    <form action="/admins/uploadImageBanner" method="post"
                                                        class="upload" enctype="multipart/form-data">
                                                        <label>Hình ảnh </label>
                                                        <div class="row">
                                                            <img src="#" class="images"
                                                                style="width: 98px; height: 100px">
                                                            <input type="file" name="img-banner" id="file-img"
                                                                class="input-img submit" accept="image/png">
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="button button-save submit"
                                                            id="addBanner" value="Lưu sản phẩm">Thêm ảnh bìa
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="manager-kindProduct">
                            ...
                            <div class="table-wrapper-scroll-y my-custom-scrollbar table-banner">
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody>
                                        <% List<PaCategory> paCategoryList = (List<PaCategory>)
                                                request.getAttribute("listPaCategory");
                                                ...
                                                <tr class="name<%=pa.getPaCategoryId()%>">
                                                    ...
                                                    <td>
                                                        <%-- <button class="edit-pa"
                                                            value="<%=pa.getPaCategoryId()%>">Lưu sữa đổi</button>--%>
                                                            <button type="button" class="delete-pa"
                                                                class="button btn-indigo btn-sm m-0 delete"
                                ...
                                <div class="modal fade" id="exampleModalCenterDanhMuc" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title uppercase" id="exampleModalLongTitleDanhMuc">Thêm
                                                    danh mục mới</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="modal-body">
                                                <form class="form-add-address">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="button button-save submit"
                                                            id="addPacategory" value="Lưu sản phẩm">Thêm Danh mục
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
