            ...
            <body>
                <%@include file="header-admin.jsp" %>
                    <div class="content">
                        <div class="manager-banner">
                            ...
                            <button type="button" class="btn-add-address button submit add" data-toggle="modal" data-target="#exampleModalCenter">Thêm
        </button>
                ...
                %>
                                            <tr class="name<%=banner.getId()%>">
                                                ...
                                                <td>
                                                    <button class="edit-banner" value="<%=banner.getId()%>" data-toggle="modal" data-target="#exampleModalCenterEdit">
                            Sửa
                        </button>
                                                    <button type="button" class="delete-banner" class="button btn-indigo btn-sm m-0 delete" value="<%=banner.getId()%>">Xóa
                        </button>
                                                </td>
                                            </tr>
                                            <%}%>
                                            ...
                                            <Ẩn></Ẩn>
                                                    ...
                                                    <form action="/admins/uploadImageBanner" method="post" class="upload" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <input type="file" name="img-banner" id="file-img" class="input-img submit" accept="image/png">
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="button button-save submit" id="addBanner" value="Lưu sản phẩm">Thêm ảnh bìa
                                    </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="manager-kindProduct">
                            ...
                            <button type="button" class="btn-add-address button submit add" data-toggle="modal" data-target="#exampleModalCenterDanhMuc">Thêm
        </button>
                            <div class="table-wrapper-scroll-y my-custom-scrollbar table-banner">
                ...
                %>
                                                    ...
                                                    <%=pa.getPaCategoryId()%>
                                                        ...
                                                        <td>
                                                            <%--                        <button class="edit-pa" value="<%=pa.getPaCategoryId()%>">Lưu sữa đổi</button>--%> =======
                                                                ...
                                                                <td>
                                                                    <%--                        <button class="edit-pa" value="<%=pa.getPaCategoryId()%>">Lưu sữa đổi</button>--%> >>>>>>> 8b207140027354ea7f2816fe25f98f72690ceafb
                                                                        <button type="button" class="delete-pa" class="button btn-indigo btn-sm m-0 delete" value="<%=pa.getPaCategoryId()%>">Xóa
                        </button>
                                ...
                                <div class="modal fade" id="exampleModalCenterDanhMuc" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-add-address">
                                                    <div class="name">
                                                        ...
                                                        <<<<<<< HEAD <input type="text" id="input-pa">
                                                    </div>
                                                    =======
                                                    <input type="text" id="input-pa">
                                            </div>
                                            >>>>>>> 8b207140027354ea7f2816fe25f98f72690ceafb
                                            <div class="modal-footer">
                                                <button type="button" class="button button-close submit" data-dismiss="modal">Hủy
                                    </button>
                                                <button type="button" class="button button-save submit" id="addPacategory" value="Lưu sản phẩm">Thêm Danh mục
                                    </button>
                                            </div>
                                            </form>
                                        </div>
                    ...
                    <<<<<<< HEAD <%-- <div class="manager-groupProduct">--%>
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    <%--                <tr class="name">--%>
                                                                                                                                                                                                                                                        <%--                    <td><%=ca.getCategoryId()%></td>--%>
                                                                                                                                                                                                                                                            <%--                    <td><%=ca.getName()%></td>--%>
                                                                                                                                                                                                                                                                <%--                    <td><%=ca.getPaCategory().getName()%></td>--%>
                                                                                                                                                                                                                                                                    <%--                    <td>--%>
                                                                                                                                                                                                                                                                        <%--                        &lt;%&ndash;                        <button class="edit-pa" value="<%=pa.getPaCategoryId()%>">Lưu
                                                                                                                                                                                                                                                                            sữa
                                                                                                                                                                                                                                                                            đổi</button>&ndash;%&gt;--%>
                                                                                                                                                                                                                                                                            <%--                        <button class="delete-ca"--%>
                                                                                                                                                                                                                                                                                <%--                                value="<%=ca.getCategoryId()%>">Xóa--%>
