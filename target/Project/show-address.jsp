                    ...
                    <div id="container">
                        ...
                        <%@include file="header.jsp" %>
                                    ...
                                    <div id="main">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                ...
                                                <button class="nav-link active" id="infor-tab" data-toggle="tab" data-target="#infor" type="button" role="tab" aria-controls="home" aria-selected="true"><i
                                class="fa-solid fa-user"></i>Thông tin tài khoản
                        </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="address-tab" data-toggle="tab" data-target="#address" type="button" role="tab" aria-controls="profile" aria-selected="false" value="<%=user.getUserId()%>">
                            ...
                            xuất</a>
                                                ...
                                                <div class="choose-address inf">
                                                    ...
                                                    class="phone-number"><%=address.getPhoneNumber()%></span></label>
                                                                ...
                                                                <div class="contain-address right">
                                                                    <button class="btn-address edit-one button submit" id="edit-address" data-toggle="modal" data-target="#exampleEditAddress<%=address.getAddressId()%>">Sửa
                                        </button>
                                                                    <button class="btn-address delete-one button submit" id="delete-address" value="<%=address.getAddressId()%>">Xóa
                                        </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <%}%>
                                                            <button type="button" class="btn-add-address button submit" data-toggle="modal" data-target="#exampleAddAddress">
                                Thêm địa chỉ mới
                            </button>
                                ...
                                <%--Modal edit address--%>
                                    <%for (Address address : addressList) {%>
                                        <div class="modal fade" id="exampleEditAddress<%=address.getAddressId()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-edit-address">
                                                            <input class="input" type="text" name="" id="input-edit-name<%=address.getAddressId()%>" placeholder="Họ tên" value="<%=address.getName()%>">
                                                            <input class="input" type="text" name="" id="input-edit-phone<%=address.getAddressId()%>" placeholder="Số điện thoại" value="<%=address.getPhoneNumber()%>">
                                                            <input class="input" type="text" name="" id="input-edit-detail<%=address.getAddressId()%>" placeholder="Số nhà, tên đường, thôn, ấp" value="<%=address.getAddressDetail().getDetail()%>">
                                                            <input class="input" type="text" name="" id="input-edit-district<%=address.getAddressId()%>" placeholder="Quận, huyện" value="<%=address.getAddressDetail().getDistrict()%>">
                                                            <input class="input" type="text" name="" id="input-edit-city<%=address.getAddressId()%>" placeholder="Tỉnh, thành phố" value="<%=address.getAddressDetail().getCity()%>">
                                                        </div>
                                                        <%}%>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="button button-close submit" data-dismiss="modal">Hủy</button>
                                                        <button type="button" class="button button-save btn-save-address submit" value="<%=address.getAddressId()%>">Lưu địa chỉ</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <%}%>
                                            <%--        end modal edit address--%>
                                                <!-- Modal add address-->
                                                <div class="modal fade" id="exampleAddAddress" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
